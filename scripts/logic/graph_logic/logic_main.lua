...
satisfactory_location = {}
satisfactory_location.__index = satisfactory_location
...
---@type table<string, satisfactory_new_return>
NAMED_LOCATIONS = {}
local stale = true
...
---@field name string
---@field side string?
---@field exits table<integer, {[1]:satisfactory_new_return, [2]:fun(): accessibilityLevel}>
---@field keys integer
...
---@param name string
---@return satisfactory_new_return
function satisfactory_location.new(name)
	if name == nil then
...
---@param exit string|satisfactory_new_return satisfactory_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function satisfactory_location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        ...
        if existing then
            ...
            exit = satisfactory_location.new(exit)
        end
    end
    if rule == nil then
        rule = always
...
---@param exit string|satisfactory_new_return satisfactory_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function satisfactory_location:connect_two_ways(exit, rule)
...
---@param exit string|satisfactory_new_return satisfactory_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function satisfactory_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
---@param exit string|satisfactory_new_return satisfactory_new_return or code/name
---@param rule? fun(): accessibilityLevel|boolean
function satisfactory_location:connect_two_ways_entrance(name, exit, rule)
...
function satisfactory_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
---@param rule1? fun(): accessibilityLevel|boolean
---@param rule2? fun(): accessibilityLevel|boolean
function satisfactory_location:connect_two_ways_stuck(exit, rule1, rule2)
...
---@return accessibilityLevel
function satisfactory_location:accessibility()
...
---@param keys integer
function satisfactory_location:discover(accessibility, keys)
...
Entry_Point = satisfactory_location.new("Entry_Point")
